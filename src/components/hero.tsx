        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="animate-fade-up">
            ...
            <p className="body-lg text-muted-foreground mb-8 max-w-md">
              ...
              ensure your educational institution remains cutting-edge.
            </p>
            ...
            <div className="flex items-center gap-6">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-linear-to-br from-blue-400 to-blue-600 border-2 border-white flex items-center justify-center text-xs font-bold text-white"
                  >
          ...
          <div className="relative animate-fade-up delay-200">
            <div className="relative">
              {/* Background blob */}
              <div className="absolute inset-0 bg-linear-to-br from-orange-100 to-orange-50 rounded-full blur-3xl opacity-60" />
