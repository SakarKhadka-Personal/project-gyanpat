      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-border">
          <div className="sm:col-span-2">
            <a href="#" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-foreground font-segoe">
                GyanPath
              </span>
            </a>
        ...
        <div className="pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} GyanPath Pvt. Ltd. All rights
            reserved.
          </p>
          <p className="text-sm text-muted-foreground">
            Design & Developed by{" "}
            ...
            >
              <span className="text-black font-medium">Sakar Khadka</span>
            </a>
          </p>
        </div>
      </div>
